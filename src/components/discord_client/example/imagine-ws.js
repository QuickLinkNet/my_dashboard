...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var client, Imagine, reroll, Variation, Upscale;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent(); // required
                    return [4 /*yield*/, client.Imagine("Red hamster smoking a cigaret --fast", function (uri, progress) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, client.Variation({
                            index: 2,
                            msgId: Imagine.id,
                            hash: Imagine.hash,
                            flags: Imagine.flags,
